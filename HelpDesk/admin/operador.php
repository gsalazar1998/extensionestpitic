...
if(isset($_SESSION['usuario'])){
	...
	if($_SESSION['nivel'] < 7 || $_SESSION['nivel'] == 9 || ($_SESSION['nivel'] != "1A" || $_SESSION['nivel'] != "2A" || $_SESSION['nivel'] != "3A" || 
	$_SESSION['nivel'] != "4A" || $_SESSION['nivel'] != "5A" || $_SESSION['nivel'] != "6A" || $_SESSION['nivel'] != "9A" || $_SESSION['nivel'] != "7A")){
		/**if($_SESSION['usuario'] == "fmorelos" || $_SESSION['usuario'] == 'eresendiz' $_SESSION['usuario'] == 'dwong'){
		...
		<div id="page">
			<div id="content" style="solid red 1px;">
				...
				<!--<div class="post" style="border:solid black 1px; width:500px;">-->
					...
					<div id="cierracaso_ven" title="Cerrar Caso"><form id="cerrarcasoSC" name="cerrarcasoSC"> Estas Seguro que quieres cerrar este caso? si es as&iacute;<br />
