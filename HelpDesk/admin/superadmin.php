...
<!--configuraciones-->
	<script type="text/javascript" src="../js/casos_superadmin.js"></script>
<!-- DataTables -->
...
<div id="wrapper">
				...
				<!--<div class="post" style="border:solid black 1px; width:500px;">-->
								...
								<div id="dynamic" class="fuente">
									...
									<div id="tabs">
										<ul>
											...
											<li><a href="#tabs-7" class="fuente">Casos Vencidos</a></li>
											<li><a href="#tabs-8" class="fuente">Actividades Extra Casos</a></li>
											<li><a href="#tabs-9" class="fuente">Aut. Act. Extracasos</a></li>
										</ul>
					...
					<p><span id="detalles" name="detalles" class="fuente"></span>
										...
										<div id="tabs-5" style="padding: 0 0 0 0;">
											...
											<table border="0" width="300px" style="padding:0 0 0 0;">
												<tr>
													...
													<td>Mostrar <br /><select id="mostrar_tipo" name="mostrar_tipo">
														...
														<option value="closed">Cerrados CON confirmacion</option>
														<option value="closedsc">Cerrados SIN confirmacion</option>
														<option value="waiting">Esperando Conf.</option>
													</select></td>
												</tr>
												<tr>
													<td>A&ntilde;o Inicial<br />
												...
												<tr>
													...
													<td><input id="vencidos" name="vencidos" type="checkbox" />&nbsp;Solo vencidos</td>
												</tr>
												<tr>
											...
											<br /><br />
											<div id='link_asignarReporte'></div>
										...
										<div id="tabs-7" style="padding: 0 0 0 0;">
											<table cellpadding="0" cellspacing="0" border="0" class="display fuente" id="casosVencidos" style="width:100%;">
												<thead>
													<tr>
														<th>ID</th>
														<th>Usuario</th>
														<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Problema&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
														<th>Hora Apertura</th>
														<th>Hora Asignaci&oacute;n</th>
														<th>Hora a Revisi&oacute;n</th>
														<th>Hora Cierre</th>
														<th>Tiempo Atenci&oacute;n</th>
														<th>Tiempo Categor&iacute;a</th>
													</tr>
												</thead>
												<tfoot>
													<tr>
											...
											<br /><br />
											<p><span id="info_casoT7" name="link_asignarT7"></span>
										</div><!--termina tabs-7 CASOS VENCIDOS-->
										<div id="tabs-8" style="padding: 0 0 0 0;">
											<form id="rpt_extra_casos">
											<table border="0" width="300px" style="padding:0 0 0 0;">
												<tr>
													<td>Fecha Inicial<br /><input id="f_ini_ec" name="f_ini_ec" type="text" "readonly" class ="sombras"/></td>
													<td>Fecha Final<br /><input id="f_fin_ec" name="f_fin_ec" type="text" "readonly" class ="sombras"/></td>
													<td>Mostrar <br /><select id="mostrar_tipo_ec" name="mostrar_tipo_ec">
														<option value="all">Todos</option>
														<option value="aut">Autorizados</option>
														<option value="notaut">No Autorizados</option>
													</select></td>
												</tr>
												<tr>
													<td>A&ntilde;o Inicial<br />
														<select id="ano_inicio_ec" name="ano_inicio_ec">
														<?php 
															for ($i=2011; $i<=3000; $i++) {
																if($i == date('Y')){
																	echo "<option value='".$i."'>".$i."</option>";
													...
													<td>A&ntilde;o Final<br />
														<select id="ano_fin_ec" name="ano_fin_ec">
														<?php 
															for ($i=2011; $i<=3000; $i++) {
																if($i == date('Y')){
																	echo "<option value='".$i."' selected>".$i."</option>";
												...
												<tr>
													<td>Folio Act. <br /><input id="no_caso_rpt_ec" name="no_caso_rpt_ec" type="text" class ="sombras" size="5"/></td>
													<td>Atendida Por:<br /><input id="asignadoa_rpt_ec" name="asignadoa_rpt_ec" type="text" class ="sombras"/></td>
												</tr>
												<tr>
													<td>Oficina <?php echo $objFN->getOficinas(); ?></td>
													<!--<td>sistema<?php //echo $objFN->getSistemas(); ?></td>-->
												...
												<tr>
													<td><a href='#' id='sub_btn_ec' class='ui-state-default ui-corner-all fuente'>Ejecutar</a></td>
												</tr>
											</table>
											</form>
											<div id="resultados_ec">
												<div id="info_casoRPT_ec"></div>
											</div>
											<br /><br />
											<div id='link_asignarReporte_ec'></div>
										</div><!-- termina tabs-8 ACTIVIDADES EXTRA CASOS-->
										<div id="tabs-9" style="padding: 0 0 0 0;">
											<table cellpadding="0" cellspacing="0" border="0" class="display fuente" id="autactec" style="width:100%;">
												<thead width="100%">
													<tr>
														<th>No. Actividad</th>
														<th>Descripcion</th>
											...
											<p><span id="info_casoPM" name="link_asignar"></span></p>
											<div id='link_asignarReporte_ec'></div>
										</div><!-- termina tabs-9 Autorizar Actividades extra caso-->
									</div><!-- termina tabs-->
								</div><!-- termina dynamic-->
					...
					<div id="infoExcepcion" title="Informacion del caso" class="fuente"></div><!-- ventana que muestra la informacion del caso-->
					<div id="infoCasoReporte" title="Informacion del caso" class="fuente"></div><!-- ventana que muestra la informacion del caso-->
					<div id="infoCasoReporte_ec" title="Informacion Actividad Extra Caso" class="fuente"></div><!-- ventana que muestra la informacion de la actividad-->
					<div id="fotos" class="fuente"></div><!-- ventana de las fotos cuando se hacen grandes-->
					<div id="respuesta_ven" title="Responder"></div>
					<div id="cierracaso_ven" title="Cerrar Caso">
					<div id="inic_revision_ven" title="Categorizar caso para iniciar revisi&oacute;n">
						<form id="iniciaRevision" name="iniciaRevision">
						<?php 
							$mysql = new MySQL();
							$mysql->connect();
							...
							//echo $comboSistemas
							echo $comboSistemas;//."<br /><br />Oficina que registro el usuario:<br />".$objFN->getOficinasOfiSelected();
							//echo $comboSistemas."<br /><br />Oficina que registro el usuario:<br />".$objFN->getOficinasOfiSelected('IZT');
						?>
						</form>
					</div>
					<form id="cerrarcasoSC" name="cerrarcasoSC">
						<input type="hidden" id="num_caso" value="" />
					<?php 
						$mysql = new MySQL();
						$mysql->connect();
						$query = "SELECT * FROM cat_sistemas";
						...
						//echo $comboSistemas
						echo "Oficina que registro el usuario:<br />".$objFN->getOficinasOfiSelected();
						//echo $comboSistemas."<br /><br />Oficina que registro el usuario:<br />".$objFN->getOficinasOfiSelected('IZT');
					?>
					<br /><br />Comentario Final: <br /><textarea id="comentarioFinal" class="validate[required]" cols="55"></textarea>
					</form></div>
					<div id="cierracaso_venT5" title="Cerrar Caso"><form id="cerrarcasoSCT5" name="cerrarcasoSCT5"> Estas Seguro que quieres cerrar este caso? si es as&iacute;<br />
					...
					<?php 
						...
						echo $comboSistemas."<br /><br />Oficina que registro el usuario:<br />".$objFN->getOficinasOfiSelected();
					?>
					<br /><br />Comentario Final: <br /><textarea id="comentarioFinalT5" class="validate[required]" cols="55"></textarea>
					</div></form>
	...
	<!-- end #wrapper2 -->
	<div id="footer">
		<p>Desarrollo y Mantenimiento del Portal por <a href="mailto:soporte@tpitic.com.mx">Misael Burboa</a> <br />(c) 2011 Transportes Pitic. 
	</div>
