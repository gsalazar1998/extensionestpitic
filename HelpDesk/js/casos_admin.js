   ...
   $.datepicker.setDefaults($.datepicker.regional['es']);
	...
	$('#cnoasignados tbody tr ').live('click', function () {
		...
		$("#asignacaso_ventana").html(
			...
			"<option value='jbenitez'>jbenitez</option>"+
...
var casosAiertos = $('#casignados').dataTable({
	...
	$('#casignados tbody tr ').live('click', function () {
		...
		$("#asignacaso_ventana").html("casos: "+asiSelected+"<br /><br /><form id='asignarcasoa' onsubmit='return: false'><input type='hidden' id='casos' name='casos' value='"+numCasoReasignado+"' /><table align='center'><td><div id='asignar'>a:&nbsp;<select id='usuarioasig' name='usuarioasig'><option value='cmburboa'>cmburboa</option><option value='acota'>acota</option><option value='jbenitez'>jbenitez</option><option value='iaguiar'>iaguiar</option><option value='gesquivel'>gesquivel</option><option value='cquintero'>cquintero</option><option value='jjara'>jjara</option><option value='eresendiz'>eresendiz</option><option value='jfavila'>jfavila</option><option value='mrios'>mrios</option><option value='dwong'>dwong</option></select></div><div id='otro'></td></tr><tr><td><div id='otro_usuario'><a id='other_user' onclick='cambiaCombo()'>Otro usuario..</a></div></td></tr></table></form>");
		//$(this).toggleClass('row_selected');
	});
...
/*******************AQUI COMIENZA LA TERCERA TABLA DE "Casos levantados por mi*********************/
	...
	$('#cabiertosxmi tbody tr ').live('click', function () {
		...
		$("#asignacaso_ventana").html("casos: "+selectedAPM+"<br /><br /><form id='asignarcasoa' onsubmit='return: false'><input type='hidden' id='casos' name='casos' value='"+selectedAPM+"' /><table align='center'><td><div id='asignar'>a:&nbsp;<select id='usuarioasig' name='usuarioasig'><option value='cmburboa'>cmburboa</option><option value='acota'>acota</option><option value='jbenitez'>jbenitez</option><option value='iaguiar'>iaguiar</option><option value='gesquivel'>gesquivel</option><option value='cquintero'>cquintero</option><option value='jjara'>jjara</option><option value='eresendiz'>eresendiz</option><option value='jfavila'>jfavila</option><option value='mrios'>mrios</option><option value='dwong'>dwong</option></select></div><div id='otro'></td></tr><tr><td><div id='otro_usuario'><a id='other_user' onclick='cambiaCombo()'>Otro usuario..</a></div></td></tr></table></form>");
	});
...
var sinConfirmacion = $('#TFaltaConfirmacion').dataTable({
	...
	$('#TFaltaConfirmacion tbody tr ').live('click', function () {
		...
		$("#asignacaso_ventana").html("casos: "+selectedSC+"<br /><br /><form id='asignarcasoa' onsubmit='return: false'><input type='hidden' id='casos' name='casos' value='"+numCasoReasignado+"' /><table align='center'><td><div id='asignar'>a:&nbsp;<select id='usuarioasig' name='usuarioasig'><option value='cmburboa'>cmburboa</option><option value='acota'>acota</option><option value='jbenitez'>jbenitez</option><option value='iaguiar'>iaguiar</option><option value='gesquivel'>gesquivel</option><option value='cquintero'>cquintero</option><option value='jjara'>jjara</option><option value='eresendiz'>eresendiz</option><option value='jfavila'>jfavila</option><option value='mrios'>mrios</option><option value='dwong'>dwong</option></select></div><div id='otro'></td></tr><tr><td><div id='otro_usuario'><a id='other_user' onclick='cambiaCombo()'>Otro usuario..</a></div></td></tr></table></form>");
		//$(this).toggleClass('row_selected');
	});
...
/*$('#todosAbiertos tbody tr ').live('click', function () {
	...
	else
	{
		...
		*/
	/*}
			$("#asignacaso_ventana").html("casos: "+asiSelectedT5+"<br /><br /><form id='asignarcasoa' onsubmit='return: false'><input type='hidden' id='casos' name='casos' value='"+numCasoReasignadoT5+"' /><table align='center'><td><div id='asignar'>a:&nbsp;<select id='usuarioasig' name='usuarioasig'><option value='cmburboa'>cmburboa</option><option value='acota'>acota</option><option value='oamaya'>oamaya</option><option value='jbenitez'>jbenitez</option><option value='iaguiar'>iaguiar</option><option value='gesquivel'>gesquivel</option><option value='cquintero'>cquintero</option><option value='evalenzuela'>evaluenzuela</option><option value='eresendiz'>eresendiz</option><option value='jferia'>jferia</option><option value='dwong'>dwong</option></select></div><div id='otro'></td></tr><tr><td><div id='otro_usuario'><a id='other_user' onclick='cambiaCombo()'>Otro usuario..</a></div></td></tr></table></form>");
//$(this).toggleClass('row_selected');
});*/
