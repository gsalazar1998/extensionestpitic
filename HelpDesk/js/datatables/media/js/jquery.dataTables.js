	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Mostrar Listado de _MENU_ Resultados",
				"sZeroRecords": "No se encontraron resultados",
				"sEmptyTable": "No hay informacion disponible en esta tabla",
		...
		function _fnLanguageProcess( oSettings, oLanguage, bInit )
		{
			...
			//_fnMap( oSettings.oLanguage, oLanguage, '<a style="text-decoration:none; float:right;" href="#" id="refresh_asignados">Recargar Tablas <img src="../img/refresh.png" /></a>' );
