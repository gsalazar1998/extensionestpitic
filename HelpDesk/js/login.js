	...
	$('#loginForm').submit(function() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data == "8A"){
					window.location = "admin/superadmin.php";
				}
				if(data == 8 || data == 7 || data == "7A" || data == "1A" || data == "2A" || data == "3A" || data == "4A" || data == "5A" || data == "6A" || data == "9A"){
					//alert("hola");
					window.location = "admin/operador.php";
				}else{
					if(data < 7 || data == 9){
