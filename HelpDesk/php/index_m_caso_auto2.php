...
if(isset($_SESSION['usuario'])){
	echo "<script>window.location = 'http://sistemas.tpitic.com.mx/HelpDesk/php/mostrar_caso_detalles.php?idcaso=".$_GET['idcaso']."'</script>";
}
	...
	$.ajax({
		...
		success: function(data) {
			if(data == 'pincorrecto'){
				...
				window.location = 'mostrar_caso_detalles.php?idcaso=".$_GET['idcaso']."'
			}
		},
