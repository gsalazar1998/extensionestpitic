					...
					<?php
						...
						$sponsors = array(
							array('Redes, Herramientas y Utilerias','Redes, Herramientas y utilerias',
								...
								<a href="apps/Firefox Setup 8.0.1.exe">Firefox 8.0.1</a><br>
								...
								<a href="apps/FileFormatConverters2007.exe">Convertidor de Archivos Office 2007</a><br>
								<a href="apps/nt3242a.exe">Net Term</a><br>
								<a href="apps/openvpn-2.1_rc19-install.exe">Open VPN</a><br>
								<a href="apps/wrar401es.exe">WinRAR</a>','toolbox.png'),
							array('Librer&iacute;as y SDK\'s','Librer&iacute;as y SDK\'s necesarias para los programas',
								...
								<a href="apps/myodbc-2.50.36-nt.exe">MyODBC 2.50.36</a><br>
								<a href="apps/mysql-connector-odbc-5.1.9-win32.msi">MySQL Connector ODBC 5.1.9</a><br>
								<a href="apps/flashplayer_11_plugin_debug.exe">Adobe Flash Netscape (Firefox)</a><br>
								<a href="apps/libsVFPRecibos.zip">Librerias Fox Pro para Recibos</a><br>',"software.png"),
							array('Antiv&iacute;rus','Programas de Antiv&iacute;rus',
								'<a href="http://vs.mcafeeasap.com/MC/rd.asp?CK=0a07050401080006080a02070e&P=VFB&G=1&I=161639&L=ESP">McAfee</a><br>',"antivirus.png"),
							array('Comunicaci&oacute;n','Programas de comunicaci&oacute;n',
								...
								<a href="apps/pidgin-2.10.2.exe">Pidgin (Windows)</a><br>',"comunicaciones.png"),
						);
