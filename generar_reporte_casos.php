...
require_once 'php/PHPExcel/PHPExcel.php';
	...
	while ($fila = $resultado1->fetch_array()) {
		...
		//ANTERIORES
		$consulta2 = "SELECT COUNT(*) AS ABIERTOS FROM casos WHERE FECHA_APERTURA < CURDATE() AND ESTADO_CASO = 1 
		...
		/*REPORTE DE LOS 5 PROBLEMAS MAS RECURRENTES POR OFICINA DURANTE LA SEMANA*/
		...
		//Agregar comentario TIEMPO PROMEDIO DE ASIGNACION DE ESTA SEMANA
		...
		//PROMEDIO DE RESOLUCION DE CASOS DE LA ULTIMA SEMANA
	...
	//if($resultado->num_rows > 0 ){
		...
		$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
		if($objWriter->save("reportecasos.xls")){
			echo "Exito";
		}else{
			echo "error";
		}
