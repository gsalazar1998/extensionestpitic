...
if(isset($_SESSION['usuario'])){
	if($_SESSION['nivel'] == 8 || $_SESSION['nivel'] == "8A"){
		/*echo "<script>window.location = 'appsadmin.php'; </script>";*/
		echo "<script>alert('asd'); </script>";
	}
	if($_SESSION['nivel']== 7){
		echo "<script>window.location = 'appsoperador.php'; </script>";
	}
	else{
...
<!--Script para validar el login-->
	<script type="text/javascript" src="js/loginapps.js"></script>
